...
#-------------------------------------------------------------------------------
# > Atualizações:
#   - 19/09/16 (v1.1.s) : Versão especial criada para selecionar cores do nome
...
module Esteem
    module NameBox
      ...
      # > Configurações da Janela e Texto:
          ...
          NB_FONT_NAME         = "Bulgaria Moderna Pro"  # Fonte do texto/nome.
      ...
      # > Configurações de Switch e Variáveis de Controle:
           ...
           POS_VAR             = 02           # Variável que define a posição(ali-
                                              # nhamento) da namebox.
           RED                 = 03           # Variável RED
           GREEN               = 04           # Variável GREEN
           BLUE                = 05           # Variável BLUE
  ...
  class Window_NameBox < Window_Base
    ...
    def draw_name
      contents.clear
      red = Esteem::NameBox::RED
      green = Esteem::NameBox::GREEN
      blue = Esteem::NameBox::BLUE
      self.contents.font.color = Color.new($game_variables[red], $game_variables[green], $game_variables[blue] , 255) 
